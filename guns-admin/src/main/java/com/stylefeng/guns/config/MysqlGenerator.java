 ...
 * 　　　┃┫┫　┃┫┫
 * 　　　┗┻┛　┗┻┛
 * @Description   mybatis-plus 代码生成 配置
 * ---------------------------------
 * @Author : zr
 * @Date :  2018/8/2713:48
 */
...
public class MysqlGenerator {
    ...
    private static String authorName="zhengr";     //作者
    private static String table="game";                  //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("111111")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/guns?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.stylefeng.guns."+packageName)// 自定义包路径
